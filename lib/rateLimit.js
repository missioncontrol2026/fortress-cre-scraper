...
const LIMITS = {
  costar: {
    // Raised 2026-07-08: 4/min was choking parallel buyer-research workflows.
    // Actual CoStar TOS export cap = 500/mo, but our path uses ScrapingBee/extension
    // (searches, not exports) so we're not constrained by that.
    perMinute: 20,
    perHour: 300,
    perDay: 1500,
    perMonth: 10000,
